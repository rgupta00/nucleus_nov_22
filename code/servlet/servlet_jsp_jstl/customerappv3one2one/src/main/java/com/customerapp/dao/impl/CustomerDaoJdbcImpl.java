        ...
        try{
          //  connection.setAutoCommit(false);
            PreparedStatement pstmt=connection
                    .prepareStatement("insert into cust(name, address,mobile, email) values(?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
          ...
          //  connection.commit();
            ...
            pstmt2.setString(3, customer.getAddress().getCountry());
...
//            }catch (SQLException e){}
    ...
    public void deleteCustomer(int id) {
        try{
            connection.setAutoCommit(false);
            PreparedStatement pstmt=connection
                    .prepareStatement("delete from cust where id=?");
            pstmt.setInt(1,id);
            pstmt.executeUpdate();
            connection.commit();
        }catch (SQLException ex){
